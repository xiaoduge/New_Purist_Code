...
/*********************************************************************
 * Function:        void CAN2515InitSPI( UINT32 pClk, UINT32 SPIClk )
 *
 * PreCondition:    None
 *
 ...
 * Note:            None.
 ********************************************************************/
void CAN2515InitSPI( UINT32 pClk, UINT32 SPIClk );
...
/*********************************************************************
 * Function:        void CAN2515SetRXB0Filters( 
 ...
 * Note:            None.
 ********************************************************************/ 
void CAN2515SetRXB0Filters( UINT32 Mask0, UINT32* pFlt0_1 );
 ...
 * Note:            None.
 ********************************************************************/ 
void CAN2515SetRXB1Filters( UINT32 Mask1, UINT32* pFlt2_5 );


/*********************************************************************
 * Function:        void CANEnable( int BusSpeed )
 *
...
/*********************************************************************
 * Function:        BOOL CANGetMsg(  UINT16 *pIdentifier, 
 ...
 * Note:            None.
 ********************************************************************/
BOOL CANGetMsg(  UINT16* pIdentifier, UINT8* Msg, UINT8* pMsgSize );


void CAN2515ByteWrite(unsigned char addr, unsigned char value );

UINT8 CAN2515ByteRead(unsigned char addr);
void CAN2515BitModify(unsigned char addr,unsigned char mask ,unsigned char value );

void CAN2515Read2Byte(unsigned char addr,unsigned char *Data0,unsigned char *Data1);

UINT8 XferSPI( UINT8 dat );

UINT8 ReadStatus2515(void);
